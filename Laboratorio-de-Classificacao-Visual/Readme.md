...
Categorias criadas:	Carro / Moto
Imagens por categoria	20 imagens cada
Critério de enviesamento	Padrão único dominante por classe
Teste de inferência	objeto nada haver com o treinamento
Resultado obtido	Classificação incorreta com alta confiança (99%)
